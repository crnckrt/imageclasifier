...
#define Command Line Arguments using the arparse module
def get_args():
...
#Load and preprocess the image dataset. Use torchvision/ ImageFolder to load the data. Using the image datasets and the trainforms, define the dataloaders
def load_data():
...
def train_model(model, train_dataset, train_loader, valid_loader, test_loader, optimizer, criterion, epochs, device):
    model.train()
...
def main():
   ...
   # print arguments
    ...
    model = train_model(model, train_dataset, train_loader, valid_loader, test_loader, optimizer, criterion, args.epochs, device)
